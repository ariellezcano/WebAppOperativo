...
@Component({
  selector: 'app-fil-operativo',
  templateUrl: './fil-operativo.component.html',
  styleUrls: ['./fil-operativo.component.scss']
})
export class FilOperativoComponent implements OnInit {

  @Output() emmit: EventEmitter<Operativo[]> = new EventEmitter();
    ...
    constructor(private wsdl: OperativoService) {
      this.busqueda = '';
      this.items = [];
