...
@Component({
  selector: 'app-fil-estado',
  templateUrl: './fil-estado.component.html',
  styleUrls: ['./fil-estado.component.scss']
})
export class FilEstadoComponent implements OnInit {

  @Output() emmit: EventEmitter<Estado[]> = new EventEmitter();
    ...
    constructor(private wsdl: EstadoService) {
      this.busqueda = '';
      this.items = [];
